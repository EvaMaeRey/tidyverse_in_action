...
```{r hi, out.width="25%", fig.cap='(ref:hi)', echo=F}
knitr::include_graphics("figures/roslings_plot.png")
```

[Number of Countries by Continent](#countriesbycontinent)


```{r, out.width="25%", fig.cap="hello", echo=F}
knitr::include_graphics("figures/countries_by_continent.png")
```
